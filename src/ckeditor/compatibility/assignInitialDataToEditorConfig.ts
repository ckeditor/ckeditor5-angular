 ...
 */
export function assignInitialDataToEditorConfig( config: EditorRelaxedConfig, data: string ): EditorConfig {
	const supports = getInstalledCKBaseFeatures();
	const configInitialData = getInitialDataFromEditorConfig( config );
